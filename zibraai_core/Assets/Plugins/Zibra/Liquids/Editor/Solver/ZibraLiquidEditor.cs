...
namespace com.zibra.liquid.Editor.Solver
{
    ...
    internal class ZibraLiquidEditor : UnityEditor.Editor
    {
        ...
        [MenuItem("GameObject/Zibra/Zibra Liquid Species Modifier", false, 50)]
        private static void CreateZibraSpeciesModifier(MenuCommand menuCommand)
        {
            String name = "ZibraLiquid Species Modifier " + (Manipulator.AllManipulators.Count + 1);
            // Create a custom game object
            var go = new GameObject(name);
        ...
        {
            CreateZibraAnalyticCollider(menuCommand, AnalyticSDF.SDFType.Sphere);
        }
        ...
        {
            CreateZibraAnalyticCollider(menuCommand, AnalyticSDF.SDFType.Box);
        }
        ...
        {
            CreateZibraAnalyticCollider(menuCommand, AnalyticSDF.SDFType.Capsule);
        }
        ...
        {
            CreateZibraAnalyticCollider(menuCommand, AnalyticSDF.SDFType.Torus);
        }
        ...
        {
            CreateZibraAnalyticCollider(menuCommand, AnalyticSDF.SDFType.Cylinder);
        }
